...
function HideChallenge()
{
    ...
    if(m_cType == 0) {jQuery('#landmark_div').css("visibility", "visible");}
    else if(m_cType == 1){jQuery('#picking_div').css("visibility", "visible");}
}
//-----------------------------------------------------------------------------
/**
...
//-----------------------------------------------------------------------------
/**
 * @description render callback kineticjs
 * @param {number} frame
 */
